document.addEventListener('astro:page-load', () => {
	...
	const vitalsHtml = [vitalCard('lcp', 'LCP', vitals.lcp), vitalCard('tbt', 'TBT', vitals.tbt), vitalCard('cls', 'CLS', vitals.cls), vitalCard('interactive', 'Interactive', vitals.interactive)].join(
		'',
	);
